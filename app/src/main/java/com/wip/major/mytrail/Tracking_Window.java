...
public class Tracking_Window extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking__window);
        ...
        mTrack.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    new StartTracking(getApplicationContext(), email, pass, uid);
                } else {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            Location location;
                ...
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 600, 100, listener );
